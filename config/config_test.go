...
func TestNew(t *testing.T) {
	...
	if got.ReactEmojiForHaiku != want.ReactEmojiForHaiku {
		t.Errorf("config.ReactEmojiForHaiku() = %#v; want: %#v", got.ReactEmojiForHaiku, want.ReactEmojiForHaiku)
	}
}
...
func TestConfig_loadReactEmojiForHaiku(t *testing.T) {
	if value := os.Getenv("REACT_EMOJI_FOR_HAIKU"); value != "" {
		os.Unsetenv("REACT_EMOJI_FOR_HAIKU")
	...
	if config.ReactEmojiForHaiku != want {
		t.Errorf("config.ReactEmojiForHaiku = %#v; want: %#v", config.ReactEmojiForHaiku, want)
	}
}
